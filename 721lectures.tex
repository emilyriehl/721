...
is contractible, which follows by the univalence axiom univalence axiom, and uses $(G,\id_G)$ as the center of contraction, and then show that the type
...
\end{cor}
\begin{proof}
For any sets $X$ and $Y$ it is straightforward to show that $X \simeq Y$ is a set.
\end{proof}
