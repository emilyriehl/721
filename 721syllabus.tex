...
\begin{itemize}
\item[-] The primary text is a book-in-progress called \emph{Introduction to Homotopy Type Theory} written by Egbert Rijke, which will be distributed via email. An online copy of an earlier version can be found here: \begin{flushright} \url{https://hott.github.io/HoTT-2019/images/hott-intro-rijke.pdf}\end{flushright}
...
\item[-] Egbert Rijke has formalized much of his book here: \begin{flushright} \url{https://github.com/EgbertRijke/HoTT-Intro/tree/master/Agda} \end{flushright}
...
\subsection*{Chat room:} \url{https://hott.zulipchat.com} in the stream \texttt{JohnsHopkins-Math721}
 ...
 \subsection*{Office hours:} Thursday evenings, exact time TBD, in Krieger 413
